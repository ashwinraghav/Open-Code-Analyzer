class CodeSubmissionsController < ApplicationController
  ...
  def show
    ...
    bayes.train(:average, ReviewedCodeMetrics.find_by_category_and_problem(:average, "Mars Rover"))
    bayes.train(:above_average, ReviewedCodeMetrics.find_by_category_and_problem(:above_average, "Mars Rover"))
